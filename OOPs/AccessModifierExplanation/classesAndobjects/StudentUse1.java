...
public class StudentUse1 {
    public static void main(String[] args) {
        ...
        s1.name = "Bishal";
        s1.rollNumber = -123;            // see if we woudnt had set this rollNumber as private in the Student class then anyone could have easily come and set invalid index, but now after making the rollNumber private no one can access our rollNumber outside the student class
